...
three times over. These are from a build %(version)s:
...
# and the build they came from. coverage.sh prints both, and says when the
# numbers have moved.
COVERAGE_VERSION = 'after libwebp 1.6.0'
COVERAGE_RUNS = [
